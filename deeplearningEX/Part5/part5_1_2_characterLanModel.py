...
# create a python dictionary to map each character to an index from 0-26
char_to_ix = { ch:i for i,ch in enumerate(sorted(chars)) }
# create a python dictionary that maps each index back to the corresponding character
...
def sample(parameters, char_to_ix, seed):
    ...
    # Step 1': Initialize a_prv as zeros
    ...
    while (idx != newline_character and counter != 50):
        ...
        y = np.squeeze(y)
        # print("y = ", y)
        idx = int(np.random.choice(vocab_size, 1, p=y))
