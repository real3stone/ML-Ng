import numpy as np
from Part5.emo_utils import *
import emoji
import matplotlib.pyplot as plt


# Version1: Just average the WordVec to predict Emoji, neglect the order of words
...
# load pretrained 50-dimensional GloVe embeddings
